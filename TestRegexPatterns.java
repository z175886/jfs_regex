...
public class TestRegexPatterns {
	...
	public void testName0() {
		System.out.println(RegexPatterns.testName("Peter Griffin"));
		System.out.println(RegexPatterns.testName("Anna-Kate Smith"));
		System.out.println(RegexPatterns.testName("Mark ONeill"));
		System.out.println(RegexPatterns.testName("Mark O'Neill"));
		System.out.println(RegexPatterns.testName("homer Simpson"));
		System.out.println(RegexPatterns.testName("homer simpson"));
		System.out.println(RegexPatterns.testName("Homer Simpson"));
...
//		assertTrue("Failed address case 10",RegexPatterns
//				.testAddress("123 Atlantic Ave.\natlanta, GA 30313"));
//	}
//
//	@Test
